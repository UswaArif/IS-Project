function check_form()
{
	...
	var letters = /^[A-Za-z]+$/;
	if(fname=="" || lname=="" || accno=="" || user_id=="" || pass=="")
	{
	...
	excel_sheet.Cells(used_rows,3).value=lname+" ";
	excel_sheet.Cells(used_rows,4).value=accno;
	excel_sheet.Cells(used_rows,5).value=user_id;
	excel_sheet.Cells(used_rows,6).value=pass;
	excel_sheet.Cells(used_rows,7).value=50000;
	if(value_cor==1)
	{
